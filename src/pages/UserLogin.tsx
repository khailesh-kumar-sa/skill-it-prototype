...
import { Eye, EyeOff, Phone, Mail, ArrowRight, Shield, User, UserPlus } from "lucide-react";
...
const UserLogin = () => {
  ...
  if (loading) {
    return (
      <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-primary via-accent to-premium">
          ...
          <Card className="border-0 shadow-2xl bg-card/95 backdrop-blur-xl relative overflow-hidden">
            ...
            <CardHeader className="text-center pb-6">
              ...
              <CardDescription className="text-muted-foreground">
                {isSignUp ? 'Join Skill It to transform your career' : 'Sign in to continue your journey'}
              </CardDescription>
            </CardHeader>
            ...
            <CardContent className="space-y-6">
              ...
              <form onSubmit={handleSubmit} className="space-y-5">
                ...
                <Button 
                  type="submit" 
                  disabled={isLoading}
                  className="w-full h-14 text-lg font-semibold bg-primary hover:bg-primary/90 transition-all duration-300 shadow-lg hover:shadow-xl group disabled:opacity-50 disabled:cursor-not-allowed"
                >
